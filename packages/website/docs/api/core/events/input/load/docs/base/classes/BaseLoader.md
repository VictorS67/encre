# Class: `abstract` BaseLoader\<CallInput, CallOutput, CallOptions\>
...
- [`BufferLoader`](../../buffer/classes/BufferLoader.md)

## Type parameters

• **CallInput** = `unknown`

The type of input the loader accepts, defaulting to unknown.

• **CallOutput** = [`Context`](../../context/classes/Context.md)[]

The type of output the loader produces, typically an array of Context objects.

• **CallOptions** *extends* [`BaseDocLoaderCallOptions`](../interfaces/BaseDocLoaderCallOptions.md) = [`BaseDocLoaderCallOptions`](../interfaces/BaseDocLoaderCallOptions.md)

The options applicable to the loader, extending BaseDocLoaderCallOptions.

## Implements

- [`DocLoader`](../interfaces/DocLoader.md)\<`CallInput`, `CallOutput`\>

## Constructors

### new BaseLoader()

> **new BaseLoader**\<`CallInput`, `CallOutput`, `CallOptions`\>(`fields`?): [`BaseLoader`](BaseLoader.md)\<`CallInput`, `CallOutput`, `CallOptions`\>

#### Parameters

• **fields?**: [`BaseLoaderParams`](../interfaces/BaseLoaderParams.md)

#### Returns

[`BaseLoader`](BaseLoader.md)\<`CallInput`, `CallOutput`, `CallOptions`\>
...
[packages/core/src/events/input/load/docs/base.ts:98](https://github.com/VictorS67/encre/blob/42c3bddca4be2d23ad959c1c99381eefbf43789c/packages/core/src/events/input/load/docs/base.ts#L98)
...
> `abstract` **load**(`source`): `Promise`\<`CallOutput`\>
...
The input source to be loaded.

#### Returns

`Promise`\<`CallOutput`\>

A Promise that resolves with the loaded output, as defined by CallOutput.

#### Implementation of

[`DocLoader`](../interfaces/DocLoader.md) . [`load`](../interfaces/DocLoader.md#load)

#### Source

[packages/core/src/events/input/load/docs/base.ts:106](https://github.com/VictorS67/encre/blob/42c3bddca4be2d23ad959c1c99381eefbf43789c/packages/core/src/events/input/load/docs/base.ts#L106)
