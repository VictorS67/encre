...
| `data`      | [ChatMessage](../../../../../events/input/load/msgs/chat/classes/ChatMessage.md) | The data structure used for chat message operations.                 |
...
### new ChatMessageNodeImpl()

> **new ChatMessageNodeImpl**(`node`): [`ChatMessageNodeImpl`](ChatMessageNodeImpl.md)
...
[`ChatMessageNodeImpl`](ChatMessageNodeImpl.md)
...
please use [getInputPortDefs](ChatMessageNodeImpl.md#getinputportdefs) instead.
...
please use [getOutputPortDefs](ChatMessageNodeImpl.md#getoutputportdefs) instead.
...
An instance of MessageNode prepared with a default ChatMessage.

#### Source

[packages/core/src/studio/nodes/input/message.node.ts:136](https://github.com/VictorS67/encre/blob/c09849eb59af073bf23be826a912f2ba4f635f93/packages/core/src/studio/nodes/input/message.node.ts#L136)
...
[packages/core/src/studio/nodes/input/message.node.ts:147](https://github.com/VictorS67/encre/blob/c09849eb59af073bf23be826a912f2ba4f635f93/packages/core/src/studio/nodes/input/message.node.ts#L147)
...
• **serializable**: [`ChatMessage`](../../../../../events/input/load/msgs/chat/classes/ChatMessage.md)

The chat message to be converted.

#### Returns

[`MessageNode`](../type-aliases/MessageNode.md)

A new instance of MessageNode.

#### Source

[packages/core/src/studio/nodes/input/message.node.ts:108](https://github.com/VictorS67/encre/blob/c09849eb59af073bf23be826a912f2ba4f635f93/packages/core/src/studio/nodes/input/message.node.ts#L108)
