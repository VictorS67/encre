...
| `data`      | [HumanMessage](../../../../../events/input/load/msgs/human/classes/HumanMessage.md) | The data structure used for human message operations.              |
...
### new HumanMessageNodeImpl()

> **new HumanMessageNodeImpl**(`node`): [`HumanMessageNodeImpl`](HumanMessageNodeImpl.md)
...
[`HumanMessageNodeImpl`](HumanMessageNodeImpl.md)
...
please use [getInputPortDefs](HumanMessageNodeImpl.md#getinputportdefs) instead.
...
please use [getOutputPortDefs](HumanMessageNodeImpl.md#getoutputportdefs) instead.
...
An instance of MessageNode prepared with a default HumanMessage.

#### Source

[packages/core/src/studio/nodes/input/message.node.ts:246](https://github.com/VictorS67/encre/blob/c09849eb59af073bf23be826a912f2ba4f635f93/packages/core/src/studio/nodes/input/message.node.ts#L246)
...
[packages/core/src/studio/nodes/input/message.node.ts:254](https://github.com/VictorS67/encre/blob/c09849eb59af073bf23be826a912f2ba4f635f93/packages/core/src/studio/nodes/input/message.node.ts#L254)
...
• **serializable**: [`HumanMessage`](../../../../../events/input/load/msgs/human/classes/HumanMessage.md)

The human message to be serialized into node form.

#### Returns

[`MessageNode`](../type-aliases/MessageNode.md)

A fully configured MessageNode specialized for human messages.

#### Source

[packages/core/src/studio/nodes/input/message.node.ts:218](https://github.com/VictorS67/encre/blob/c09849eb59af073bf23be826a912f2ba4f635f93/packages/core/src/studio/nodes/input/message.node.ts#L218)
