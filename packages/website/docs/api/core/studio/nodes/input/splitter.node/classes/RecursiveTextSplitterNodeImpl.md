# Class: RecursiveTextSplitterNodeImpl
...
| `subType`       | [SupportedLanguageForSplit](../../../../../events/input/transform/splitter/type-aliases/SupportedLanguageForSplit.md) or `'paragraph'` | The subtype of the node, specifying the language or defaulting to 'paragraph' for text data. |
| `registerArgs`  | `{ language: '<supported-language>' }` | Optional arguments specifying the language used for splitting.             |
| `data`          | [RecursiveTextSplitter](../../../../../events/input/transform/splitter/classes/RecursiveTextSplitter.md) | The callable used for recursive text splitting operations.                  |
...
### new RecursiveTextSplitterNodeImpl()

> **new RecursiveTextSplitterNodeImpl**(`node`): [`RecursiveTextSplitterNodeImpl`](RecursiveTextSplitterNodeImpl.md)
...
please use [getInputPortDefs](RecursiveTextSplitterNodeImpl.md#getinputportdefs) instead.
...
please use [getOutputPortDefs](RecursiveTextSplitterNodeImpl.md#getoutputportdefs) instead.
...
An instance of SplitterNode prepared with a default RecursiveTextSplitter.

#### Source

[packages/core/src/studio/nodes/input/splitter.node.ts:368](https://github.com/VictorS67/encre/blob/c09849eb59af073bf23be826a912f2ba4f635f93/packages/core/src/studio/nodes/input/splitter.node.ts#L368)
...
[packages/core/src/studio/nodes/input/splitter.node.ts:377](https://github.com/VictorS67/encre/blob/c09849eb59af073bf23be826a912f2ba4f635f93/packages/core/src/studio/nodes/input/splitter.node.ts#L377)
...
Optional parameters to specify the language used for splitting, influencing the splitting strategy.
...
A fully configured SplitterNode specialized for recursive text operations.

#### Source

[packages/core/src/studio/nodes/input/splitter.node.ts:331](https://github.com/VictorS67/encre/blob/c09849eb59af073bf23be826a912f2ba4f635f93/packages/core/src/studio/nodes/input/splitter.node.ts#L331)
