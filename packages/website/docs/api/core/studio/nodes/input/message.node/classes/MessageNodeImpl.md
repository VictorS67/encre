# Class: `abstract` MessageNodeImpl
...
- [`NodeImpl`](../../../base/classes/NodeImpl.md) \<[`MessageNode`](../type-aliases/MessageNode.md)\>
...
> **new MessageNodeImpl**(`node`): [`MessageNodeImpl`](MessageNodeImpl.md)
...
please use [getInputPortDefs](MessageNodeImpl.md#getinputportdefs) instead.
...
please use [getOutputPortDefs](MessageNodeImpl.md#getoutputportdefs) instead.
...
[packages/core/src/studio/nodes/input/message.node.ts:42](https://github.com/VictorS67/encre/blob/c09849eb59af073bf23be826a912f2ba4f635f93/packages/core/src/studio/nodes/input/message.node.ts#L42)
