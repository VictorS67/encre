...
| `data`      | [Gemini](../../../../../../events/inference/chat/llms/vertexai/gemini/text/classes/Gemini.md)| The callable used for interacting with Gemini's language models.                  |
...
> **new GeminiNodeImpl**(`node`): [`GeminiNodeImpl`](GeminiNodeImpl.md)
...
please use [getInputPortDefs](GeminiNodeImpl.md#getinputportdefs) instead.
...
please use [getOutputPortDefs](GeminiNodeImpl.md#getoutputportdefs) instead.
...
A map of outputs as processed by the node, including the generated output, additional information, and token usage details.
...
An instance of LLMNode prepared with a Gemini configured for advanced language model operations.
...
• **callable**: [`Gemini`](../../../../../../events/inference/chat/llms/vertexai/gemini/text/classes/Gemini.md) \<[`GeminiCallOptions`](../../../../../../events/inference/chat/llms/vertexai/interfaces/GeminiCallOptions.md)\>

An instance of Gemini defining the interaction logic with Gemini's language models.

#### Returns

[`LLMNode`](../type-aliases/LLMNode.md)

A fully configured LLMNode specialized for Gemini operations.
