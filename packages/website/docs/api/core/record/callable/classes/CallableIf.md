# Class: CallableIf\<CallInput, CallOutput, CallOptions\>
...
Type of input the callable will accept.

• **CallOutput** *extends* `Record`\<`string`, `unknown`\> = `Record`\<`string`, `unknown`\>

Type of output the callable will produce, typically a record mapping keys to outputs of individual callables.

• **CallOptions** *extends* [`CallableIfConfig`](../type-aliases/CallableIfConfig.md) = [`CallableIfConfig`](../type-aliases/CallableIfConfig.md)

Extends [CallableIfConfig](../type-aliases/CallableIfConfig.md) to include additional configuration specific to conditional execution.

## Constructors

### new CallableIf()

> **new CallableIf**\<`CallInput`, `CallOutput`, `CallOptions`\>(`fields`): [`CallableIf`](CallableIf.md)\<`CallInput`, `CallOutput`, `CallOptions`\>
...
An object containing the rules, actions, and optionally a default callable.

• **fields.actions**: `Record`\<`string`, [`CallableLike`](../type-aliases/CallableLike.md)\<`CallInput`, `unknown`\>\>

• **fields.default?**: [`CallableLike`](../type-aliases/CallableLike.md)\<`CallInput`, `unknown`\>

• **fields.rules**: `Record`\<`string`, [`BaseRule`](../../../events/inference/validate/guardrails/base/classes/BaseRule.md)\<`any`\>\>

#### Returns

[`CallableIf`](CallableIf.md)\<`CallInput`, `CallOutput`, `CallOptions`\>
...
Error if an action does not have a corresponding rule.

#### Source

[packages/core/src/record/callable.ts:1826](https://github.com/VictorS67/encre/blob/42c3bddca4be2d23ad959c1c99381eefbf43789c/packages/core/src/record/callable.ts#L1826)

## Properties

### \_actions

> `protected` **\_actions**: `Record`\<`string`, [`Callable`](Callable.md)\<`CallInput`, `unknown`, [`CallableConfig`](../type-aliases/CallableConfig.md)\>\>

A mapping of callables to be potentially executed, each associated with a specific rule.

#### Source

[packages/core/src/record/callable.ts:1813](https://github.com/VictorS67/encre/blob/42c3bddca4be2d23ad959c1c99381eefbf43789c/packages/core/src/record/callable.ts#L1813)

***

### \_default?

> `protected` `optional` **\_default**: [`Callable`](Callable.md)\<`CallInput`, `unknown`, [`CallableConfig`](../type-aliases/CallableConfig.md)\>

An optional default callable to be executed if no rules are satisfied.

#### Source

[packages/core/src/record/callable.ts:1818](https://github.com/VictorS67/encre/blob/42c3bddca4be2d23ad959c1c99381eefbf43789c/packages/core/src/record/callable.ts#L1818)
...
[packages/core/src/record/callable.ts:1795](https://github.com/VictorS67/encre/blob/42c3bddca4be2d23ad959c1c99381eefbf43789c/packages/core/src/record/callable.ts#L1795)
...
[packages/core/src/record/callable.ts:1797](https://github.com/VictorS67/encre/blob/42c3bddca4be2d23ad959c1c99381eefbf43789c/packages/core/src/record/callable.ts#L1797)
...
[packages/core/src/record/callable.ts:1799](https://github.com/VictorS67/encre/blob/42c3bddca4be2d23ad959c1c99381eefbf43789c/packages/core/src/record/callable.ts#L1799)

***

### \_rules

> `protected` **\_rules**: `Record`\<`string`, [`BaseRule`](../../../events/inference/validate/guardrails/base/classes/BaseRule.md)\<`any`\>\>

A mapping of rules that determine whether the associated callable actions should be executed.

#### Source

[packages/core/src/record/callable.ts:1808](https://github.com/VictorS67/encre/blob/42c3bddca4be2d23ad959c1c99381eefbf43789c/packages/core/src/record/callable.ts#L1808)
...
Optional additional options influencing the callable execution.

#### Returns

`Promise`\<`CallOutput`\>

A promise that resolves to the output of the executed callable, or the default output if no callable is executed.
...
[packages/core/src/record/callable.ts:1878](https://github.com/VictorS67/encre/blob/42c3bddca4be2d23ad959c1c99381eefbf43789c/packages/core/src/record/callable.ts#L1878)
...
[packages/core/src/record/callable.ts:1801](https://github.com/VictorS67/encre/blob/42c3bddca4be2d23ad959c1c99381eefbf43789c/packages/core/src/record/callable.ts#L1801)

***

### from()

> `static` **from**\<`CallInput`\>(`rules`, `actions`, `defaultCallable`?): [`CallableIf`](CallableIf.md)\<`CallInput`, `Record`\<`string`, `unknown`\>, [`CallableIfConfig`](../type-aliases/CallableIfConfig.md)\>
...
• **rules**: `Record`\<`string`, [`BaseRule`](../../../events/inference/validate/guardrails/base/classes/BaseRule.md)\<`any`\>\>

The rules for the callable instance.

• **actions**: `Record`\<`string`, [`CallableLike`](../type-aliases/CallableLike.md)\<`CallInput`, `unknown`\>\>

The actions for the
callable instance.

• **defaultCallable?**: [`CallableLike`](../type-aliases/CallableLike.md)\<`CallInput`, `unknown`\>

#### Returns

[`CallableIf`](CallableIf.md)\<`CallInput`, `Record`\<`string`, `unknown`\>, [`CallableIfConfig`](../type-aliases/CallableIfConfig.md)\>

A new instance of `CallableIf`.

#### Source

[packages/core/src/record/callable.ts:1858](https://github.com/VictorS67/encre/blob/42c3bddca4be2d23ad959c1c99381eefbf43789c/packages/core/src/record/callable.ts#L1858)
